...
export function graphql(
	source: 'mutation UpdateSettings($input: SettingsInput) {\n  update_settings(input: $input) {\n    id\n    downloads {\n      id\n      updatedAt\n    }\n  }\n}'
): (typeof documents)['mutation UpdateSettings($input: SettingsInput) {\n  update_settings(input: $input) {\n    id\n    downloads {\n      id\n      updatedAt\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: 'query GetGenres {\n  genres {\n    id\n    name\n    description\n  }\n}'
): (typeof documents)['query GetGenres {\n  genres {\n    id\n    name\n    description\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: 'query GetSettings {\n  settings {\n    id\n    downloads {\n      id\n      updatedAt\n      audioPath\n      videoPath\n      imagePath\n      metadataPath\n      path\n    }\n  }\n}'
): (typeof documents)['query GetSettings {\n  settings {\n    id\n    downloads {\n      id\n      updatedAt\n      audioPath\n      videoPath\n      imagePath\n      metadataPath\n      path\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: 'query GetTracks {\n  tracks {\n    id\n    title\n    genre {\n      id\n      name\n      description\n    }\n    bitrate\n    originalUrl\n    author {\n      id\n      name\n      provider {\n        id\n        name\n        domain\n      }\n    }\n    file {\n      id\n      location\n    }\n    contributors {\n      id\n      name\n    }\n    duration\n    thumbnail {\n      width\n      height\n      id\n      file {\n        id\n        location\n      }\n    }\n  }\n}'
): (typeof documents)['query GetTracks {\n  tracks {\n    id\n    title\n    genre {\n      id\n      name\n      description\n    }\n    bitrate\n    originalUrl\n    author {\n      id\n      name\n      provider {\n        id\n        name\n        domain\n      }\n    }\n    file {\n      id\n      location\n    }\n    contributors {\n      id\n      name\n    }\n    duration\n    thumbnail {\n      width\n      height\n      id\n      file {\n        id\n        location\n      }\n    }\n  }\n}']
