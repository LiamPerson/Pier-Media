...
export type UpdateSettingsMutation = {
	__typename?: 'Mutation'
	update_settings: { __typename?: 'Settings'; id: number; downloads: { __typename?: 'DownloadSettings'; id: number; updatedAt: string } }
}
...
export type GetGenresQuery = {
	__typename?: 'Query'
	genres: Array<{ __typename?: 'Genre'; id: number; name: string; description: string } | null>
}
...
export type GetTracksQuery = {
	...
	tracks: Array<{
		...
		originalUrl: string
		duration: number
		genre?: { __typename?: 'Genre'; id: number; name: string; description: string } | null
		author: {
			__typename?: 'Author'
			id: number
			name: string
			provider: { __typename?: 'Provider'; id: number; name: string; domain: string }
		}
		file: { __typename?: 'File'; id: number; location: string }
		contributors?: Array<{ __typename?: 'Author'; id: number; name: string } | null> | null
		thumbnail: {
			__typename?: 'Image'
			width: number
			height: number
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'update_settings' },
						arguments: [
							{
								kind: 'Argument',
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: 'Field', name: { kind: 'Name', value: 'videoPath' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'imagePath' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'metadataPath' } },
