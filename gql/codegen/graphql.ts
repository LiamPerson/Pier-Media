...
export type GetTracksQuery = { __typename?: 'Query', tracks: Array<{ __typename?: 'Track', id: number, title: string, bitrate: number, originalUrl: string, duration: number, genre?: { __typename?: 'Genre', id: number, name: string, description: string } | null, author: { __typename?: 'Author', id: number, name: string, provider: { __typename?: 'Provider', id: number, name: string, domain: string } }, file: { __typename?: 'File', id: number, location: string }, contributors?: Array<{ __typename?: 'Author', id: number, name: string } | null> | null } | null> };
